    ...
    <section id="about" className="relative py-20 px-4 md:px-6 lg:px-8 md:py-32 overflow-hidden" style={{ background: 'linear-gradient(to bottom, #000000, rgba(220, 38, 38, 0.08))' }}>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12 mb-20">
          <div className={`animate-slide-in-left transition-all duration-1000`}>
          ...
          <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4 md:gap-6 animate-slide-in-right`}>
            {highlights.map((highlight, index) => {
              const Icon = highlight.icon;
              return (
                <div
                  key={index}
                  className="p-6 rounded-lg transition-all duration-300 hover:scale-105 cursor-pointer"
                  style={{
        ...
        <div className="mt-20">
          <h3 className="text-2xl font-bold mb-4" style={{ color: '#F5F5F5' }}>Education</h3>
          <div className="mb-8 p-6 rounded-lg" style={{ backgroundColor: 'rgba(17, 17, 17, 0.92)', border: '1px solid rgba(220, 38, 38, 0.2)' }}>
          ...
          <h3 className="text-2xl font-bold mb-4 mt-12" style={{ color: '#F5F5F5' }}>Recent Experience</h3>
          ...
          {[
            ...
            <div key={idx} className="mb-6 p-6 rounded-lg" style={{ backgroundColor: 'rgba(17, 17, 17, 0.92)', border: '1px solid rgba(220, 38, 38, 0.2)' }}>
